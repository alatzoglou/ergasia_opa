...
(function () {
	...
	new videoBackground('container03', {
		target: '#container03',
		src: 'assets/videos/container03.mp4',
		poster: 'assets/videos/container03.mp4.jpg',
		position: 'center',
		loop: true
	});
	...
	(function () {
		...
		new slideshowBackground('slideshow03', {
			...
			images: [
				{
					src: 'assets/images/slideshow03-ac221e95.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
				...
				{
					src: 'assets/images/slideshow03-38589f19.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
				...
				{
					src: 'assets/images/slideshow03-7b371477.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
				...
				{
					src: 'assets/images/slideshow03-1f58e273.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
				...
				{
					src: 'assets/images/slideshow03-9c4e18d3.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
				...
				{
					src: 'assets/images/slideshow03-1efc012b.jpg',
					position: 'center',
					motion: 'none',
					speed: 2,
					caption: 'Untitled',
	...
	onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('.image.style6', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text10', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text11', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('.image.style4', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text08', { style: 'tilt-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text09', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons07', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#container04', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text25', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text26', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('.image.style7', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text05', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text19', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text06', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#video02', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#icons04', { style: 'slide-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text23', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text16', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons01', { style: 'slide-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text20', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text13', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons03', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text22', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text15', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons02', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text21', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text02', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#form01', { style: 'blur-in', speed: 3000, intensity: 5, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#video01', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text24', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#slideshow03', { style: 'slide-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text12', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text18', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#icons05', { style: 'slide-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('.image.style5', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#text01', { style: 'slide-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text04', { style: 'flip-left', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text07', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text14', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#icons09', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#buttons02', { style: 'blur-in', speed: 1500, intensity: 0, threshold: 3, delay: 0, state: true, replay: true });
	onvisible.add('#text17', { style: 'slide-right', speed: 1500, intensity: 10, threshold: 3, delay: 0, state: true, replay: true });
